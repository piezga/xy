...
binders512_low = np.load(f'data/sigma_{sigmastr}/simulation_low_512_analyzed/meanbinders.npy')
...
errbinders512_low = np.load(f'data/sigma_{sigmastr}/simulation_low_512_analyzed/errbinders.npy')
...
binders256_high = np.load(f'data/sigma_{sigmastr}/simulation_real/meanbinders.npy')
...
# for i, index in enumerate(indices):
#     binders512_others[0,i] = binderslow[5,index]
binders512_high = np.load(f'data/sigma_{sigmastr}/simulation_high_512_analyzed/meanbinders.npy')
...
# binders1024 = [binders1024_001, binders1024_003, binders1024_005, binders1024_042, binders1024_05]
# binders1024 = np.array(binders1024)
binders1024_high = np.load(f'data/sigma_{sigmastr}/simulation_real_1/meanbinders.npy')
...
errbinders256_high = np.load(f'data/sigma_{sigmastr}/simulation_real/errbinders.npy')
...
errbinders512_high = np.load(f'data/sigma_{sigmastr}/simulation_high_512_analyzed/errbinders.npy')
...
# errbinders1024 = [errbinders1024_001, errbinders1024_003, errbinders1024_005, errbinders1024_042, errbinders1024_05]
# errbinders1024 = np.array(errbinders1024)
errbinders1024_high = np.load(f'data/sigma_{sigmastr}/simulation_real_1/errbinders.npy')
...
np.save(f'data/sigma_{sigmastr}/simulation_binders/meanbinders.npy', meanbinders, allow_pickle=True)
np.save(f'data/sigma_{sigmastr}/simulation_binders/errbinders.npy', errbinders, allow_pickle=True)
